...
from seq2seq.constrained_t5 import ConstraintSeq2SeqTrainingArguments, ConstraintSeq2SeqTrainer, gcn_model, DataCollatorForSeq2Seq_edges
    ...
    def get_edges(text):
        ...
        for i, token1 in enumerate(doc):
            for j, token2 in enumerate(doc):
                if (j != i and i!=0 and i!=1 and j!=0 and j!=1):
