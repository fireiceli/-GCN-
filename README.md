...
```
bash run_seq2seq_gcn.bash -d 0 -f tree -m bart-large --label_smoothing 0 -l 5e-5 --lr_scheduler linear --warmup_steps 2000 -b 8 -i one_ie_ere_en_subtype
...
bash run_seq2seq_with_pretrain.bash -d 0 -f tree -m bart_large --label_smoothing 0 -l 5e-5 --lr_scheduler linear --warmup_steps 2000 -b 8 -i dyiepp_ace2005_subtype
